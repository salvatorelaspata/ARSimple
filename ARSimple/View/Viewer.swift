...
//  ARSimple
//
//  Created by Salvatore La Spata on 26/08/22.
//
...
struct Viewer: View {
    ...
    private var models: [Model] {
        ...
        for filename in files where
        filename.hasSuffix("reality") {
            let modelName = filename.replacingOccurrences(of: ".reality", with: "")
            
            let model = Model(modelName: modelName)
            
            aviableModels.append(model)
        }
        print("DEBUG: aviableModels \(aviableModels.count)")
